...
- Being respectful, constructive, and precise in feedback.
...
This Code of Conduct applies within all project spaces (repository, issue tracker, pull requests, discussions) and also applies when an individual is officially representing the project in public spaces.
...
3. **Temporary ban**: temporary suspension from interaction.
4. **Permanent ban**: permanent exclusion from the project.
